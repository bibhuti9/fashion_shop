...
<head>
    ...
    <meta charset="utf-8">
        ...
        if(isset($_POST['subcsubmit'])){
            $data = array(
                "scat_name" => $_POST['subcsname'],
                "cat_id" => $_POST['categoury'],
            );
            add_data('tbl_subcategory',$data,$con);
        ?>
                            ...
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">Subcategory</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="card-block">
                                            <div class="form-group row">
                                             ...
                                             <div class="col-sm-12 m-b-5">
                                                ...
                                                <select name="categoury" class="form-control ">
                                                        <option value="opt1">Category</option>
                                                        <?php  
                                                            $query="select * from tbl_category";
                                                         $val=mysqli_query($con,$query) or die("<script>alert('Data is not fetch on categorys');</script>");
                                                            if(mysqli_num_rows($val)>0){
                                                                while($cat=mysqli_fetch_assoc($val)){
                                                        ?>
                                                                    <option value="<?php echo $cat['cat_id'] ?>" name="category"><?php echo $cat['cat_name']?></option>
                                                        <?php           
                                                                }
                                                            }
                                                        ?> 
                                                ...
                                                <input type="text" name="subcsname" class="form-control"
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            <div class="col-sm-12 text-right">
                                                <button type="submit" name="subcsubmit" class="btn btn-primary m-r-10">Add
                                                    </button>
