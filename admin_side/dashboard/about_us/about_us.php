           ...
           <script src="js/jquery.min.js"></script>
            <script>
                $("document").ready(()=>{
                    ...
                    .then((value) => {
                window.location.assign('about_us.php');
                            ...
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="#!">About_us</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="card-block">
                                            ...
                                            <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                <div class="col-sm-12 m-b-5">
                                                    <label>Society</label>
                                                    <input type="text" name="a_society" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 m-b-5">
                                                    <label>Area</label>
                                                    <input type="text" name="a_area" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 m-b-5">
                                                    <label>State</label>
                                                    <input type="text" name="a_state" class="form-control"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 m-b-5">
                                                    <label>Pincode</label>
                                                    <input type="number" name="a_pincode" class="form-control"
                                                        placeholder="Enter Pincode Name" required="">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 m-b-5">
                                                    ...
                                                    <input type="number" name="a_contact_no" class="form-control"
                                                        placeholder="Enter Contact_no Name" required="">
                                                </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            <div class="col-sm-12 text-right">
                                                <button type="submit" name="about_us_submit" class="btn btn-primary m-r-10">Add
                                                 </button>
