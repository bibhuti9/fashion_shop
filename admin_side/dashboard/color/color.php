...
<head>
    ...
    <meta charset="utf-8">
        ...
        if(isset($_POST['color_add'])){
            $data = array(
                "color_code" => $_POST['txtColorcode'],
                "color_name" => $_POST['txtColorname'],
            );
            add_data('tbl_color',$data,$con);
        ?>
                                    ...
                                    <div class="card-block">
                                         <div class="form-group row">
                                                <div class="col-lg-3 m-b-5">
                                                   <label for="comment">chose Color :-</label>
                                                   <input type="color"class="form-control"  name="txtColorcode" required="">
                                                </div>
                                            </div> 
                                            <div class="form-group row">
                                               
                                                <div class="col-sm-12 m-b-5">
                                                    <input type="text" name="txtColorname" class="form-control" placeholder="Enter color Name"required="">
                                                </div>
                                            </div>  
                                    </div>
                                    <div class="card-footer">
                                        <div class="row">
                                            <div class="col-sm-12 text-right">
                                                <button type="submit" name="color_add" class="btn btn-primary m-r-10">Add</button>
